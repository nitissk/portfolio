...
import { technicalSkills, toolsTechnologies, softSkills } from "../../Data"; 
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 bg-gray-800/30 p-8 rounded-xl border border-gray-700"
        >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {toolsTechnologies.map((tool, index) => (
              <motion.div
                ...
                className="px-4 py-2 bg-gray-700 rounded-full text-gray-300 hover:text-white hover:bg-gray-600 transition-all"
              >
                {tool}
              </motion.div>
            ))}

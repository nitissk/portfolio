...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=nitishkumarsingh2250@gmail.com&su=Message from ${encodeURIComponent(name)}&body=${encodeURIComponent(
      `Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`
    )}`;
            ...
            <form ref={form} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-white placeholder-gray-400"
                  placeholder="Hi Nitish, I'd like to talk about..."
                ></textarea>
              </div>
              ...
              <button
                type="submit"
                disabled={isSending}
                className={`w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg transition-all duration-300 ${
                  isSending
